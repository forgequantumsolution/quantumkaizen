...
const ApiDependencyMonitor = ({
  formSchema,
  formValues,
  fetchApiDependentOptions,
  setFieldValue,
}) => {
  useEffect(() => {
    const allFields =
    ...
    const apiDependentFields = allFields.filter(
      (field) =>
...
const PreviewFormInBuilder = ({
  ...
  const fetchApiDependentOptions = async (field, dependencyValue) => {
    ...
    try {
      ...
      console.error(
        `Error fetching dependent options for ${field.name}:`,
        error,
      );
    }
  };
    ...
    return (
      ...
      >
        ...
        <Space>
          ...
          <Button size="small" danger icon={<NxTrash />} onClick={onRemove}>
            Remove
          </Button>
        </Space>
      </div>
                ...
                formSchema.sections
                  ...
                  .map((section, idx) => {
                    return (
                      <div
                        key={idx}
                        className="my-4 border border-gray-200 p-4 rounded-lg"
                      >
...
export default PreviewFormInBuilder;
