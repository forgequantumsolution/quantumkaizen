...
export const mockCAPAs: CAPARecord[] = [
  ...
  // ── 2025 records ──
  {
    ...
    title: 'Porosity in die castings — process parameter optimisation',
    description: 'Gas porosity in aluminium die castings lot ADC-2025-067 exceeded acceptance criterion. 8/50 units rejected. Die venting channels blocked due to extended cycle without maintenance causing gas entrapment.',
    source: 'NC', status: 'CLOSED', severity: 'MAJOR',
    department: 'Production', productProcess: 'Die Casting',
    linkedSourceRecord: 'NC-2025-0031',
    owner: 'Vikram Patel', ownerId: 'u4', dueDate: '2025-12-15',
    fiveWhys: [
      { whyNumber: 1, question: 'Why was porosity present in the castings?', answer: 'Insufficient venting during die filling allowed gas entrapment.' },
      { whyNumber: 2, question: 'Why was venting insufficient?', answer: 'Die vents were blocked with aluminium flash from extended production cycles.' },
      { whyNumber: 3, question: 'Why were vents blocked?', answer: 'Preventive maintenance was overdue by 3 weeks.' },
      { whyNumber: 4, question: 'Why was maintenance overdue?', answer: 'No CMMS alert system existed for die vent cleaning intervals.' },
    ],
    fishbone: {
      man: [],
      machine: [{ id: 'fb1', text: 'Die vent maintenance overdue — blocked vents' }],
      material: [],
      method: [{ id: 'fb2', text: 'No PM trigger configured for vent cleaning interval' }],
      measurement: [],
      environment: [],
    },
    actions: [
      { id: 'a10', description: 'Clean and inspect all die vents on Die-07 and Die-08', type: 'CORRECTIVE', owner: 'Vikram Patel', dueDate: '2025-11-10', status: 'COMPLETED', completedDate: '2025-11-08' },
      { id: 'a11', description: 'Add die vent inspection to 2-weekly PM checklist', type: 'PREVENTIVE', owner: 'Deepak Nair', dueDate: '2025-11-20', status: 'COMPLETED', completedDate: '2025-11-18' },
      { id: 'a12', description: 'Configure CMMS alert for vent cleaning at 500-shot intervals', type: 'PREVENTIVE', owner: 'Deepak Nair', dueDate: '2025-11-30', status: 'COMPLETED', completedDate: '2025-11-28' },
    ],
    effectivenessCriteria: 'Zero porosity rejects in next 3 production lots',
    monitoringPeriodDays: 60,
    effectivenessResult: 'PASS',
    effectivenessEvidence: 'Lots ADC-2025-081, ADC-2025-088, ADC-2025-094 all passed with zero porosity rejections.',
    history: [
      { id: 'h30', timestamp: '2025-10-28T10:00:00Z', user: 'Priya Sharma', action: 'CAPA Initiated', details: 'Created from NC-2025-0031' },
      { id: 'h31', timestamp: '2025-11-30T16:00:00Z', user: 'Vikram Patel', action: 'Actions Completed', details: 'All corrective and preventive actions completed' },
      { id: 'h32', timestamp: '2026-01-28T10:00:00Z', user: 'Priya Sharma', action: 'Closed', details: 'Effectiveness verified — 3 successive lots with zero porosity rejections' },
    ],
    createdAt: '2025-10-28T10:00:00Z', updatedAt: '2026-01-28T10:00:00Z', closedAt: '2026-01-28T10:00:00Z', createdBy: 'Priya Sharma',
  },
  {
    id: 'capa-2025-001', capaNumber: 'CAPA-2025-0015',
    title: 'Elimination of material substitution errors in order fulfilment',
    description: 'Wrong material grade supplied on order ORD-2025-112 (carbon steel vs stainless steel). Customer halted installation at offshore site. Material pick list not cross-referenced against purchase order specification at packing stage.',
    source: 'NC', status: 'CLOSED', severity: 'CRITICAL',
    department: 'Quality Assurance', productProcess: 'Stores and Dispatch',
    linkedSourceRecord: 'NC-2025-0008',
    owner: 'Priya Sharma', ownerId: 'u1', dueDate: '2025-04-30',
    fiveWhys: [
      { whyNumber: 1, question: 'Why was wrong material grade shipped?', answer: 'Carbon steel picked from shelf adjacent to stainless steel stock.' },
      { whyNumber: 2, question: 'Why was carbon steel picked from wrong shelf?', answer: 'Part numbers were similar and storage areas were not colour-coded.' },
      { whyNumber: 3, question: 'Why was the error not detected at packing?', answer: 'Packing checklist did not require material grade verification before sealing.' },
    ],
    fishbone: {
      man: [],
      machine: [],
      material: [{ id: 'fb3', text: 'Similar part numbers for adjacent carbon and stainless steel stock' }],
      method: [{ id: 'fb4', text: 'No material grade verification step in packing SOP' }],
      measurement: [],
      environment: [{ id: 'fb5', text: 'Carbon and stainless steel stored in adjacent locations without colour-coding' }],
    },
    actions: [
      { id: 'a13', description: 'Introduce colour-coded bin labelling for carbon vs stainless steel', type: 'CORRECTIVE', owner: 'Rajesh Kumar', dueDate: '2025-03-20', status: 'COMPLETED', completedDate: '2025-03-18' },
      { id: 'a14', description: 'Update packing SOP to require material grade scan-verification before sealing', type: 'CORRECTIVE', owner: 'Priya Sharma', dueDate: '2025-03-25', status: 'COMPLETED', completedDate: '2025-03-24' },
      { id: 'a15', description: 'Train all stores and dispatch personnel on updated packing procedure', type: 'PREVENTIVE', owner: 'Sunita Rao', dueDate: '2025-04-05', status: 'COMPLETED', completedDate: '2025-04-04' },
    ],
    effectivenessCriteria: 'Zero material substitution complaints in 6 months following closure',
    monitoringPeriodDays: 180,
    effectivenessResult: 'PASS',
    effectivenessEvidence: 'No material substitution complaints in Sep 2025 review covering Apr–Sep 2025.',
    history: [
      { id: 'h33', timestamp: '2025-03-01T10:00:00Z', user: 'Priya Sharma', action: 'CAPA Initiated', details: 'Created from NC-2025-0008' },
      { id: 'h34', timestamp: '2025-04-05T11:00:00Z', user: 'Priya Sharma', action: 'Actions Completed', details: 'All actions completed' },
      { id: 'h35', timestamp: '2025-09-20T10:00:00Z', user: 'Priya Sharma', action: 'Closed', details: 'Effectiveness verified — no recurrence in 6-month monitoring window' },
    ],
    createdAt: '2025-03-01T10:00:00Z', updatedAt: '2025-09-20T10:00:00Z', closedAt: '2025-09-20T10:00:00Z', createdBy: 'Priya Sharma',
  },
  // ── 2024 records ──
  {
    id: 'capa-2024-002', capaNumber: 'CAPA-2024-0042',
    title: 'Weld undercut prevention — welder qualification programme',
    description: 'Weld undercut of 0.8mm on pressure vessel WS-2024-088 exceeded ASME IX limit of 0.4mm. Welder W-007 not recently re-qualified for thin-wall pressure vessel work. Supervisor oversight reduced due to overtime scheduling.',
    source: 'NC', status: 'CLOSED', severity: 'CRITICAL',
    department: 'Production', productProcess: 'Pressure Vessel Welding',
    linkedSourceRecord: 'NC-2024-0045',
    owner: 'Vikram Patel', ownerId: 'u4', dueDate: '2024-12-31',
    fiveWhys: [
      { whyNumber: 1, question: 'Why did weld undercut exceed ASME IX limit?', answer: 'Welder used incorrect travel speed for the material thickness.' },
      { whyNumber: 2, question: 'Why was incorrect travel speed used?', answer: 'Welder was not qualified for this specific weld joint configuration.' },
      { whyNumber: 3, question: 'Why was an unqualified welder assigned?', answer: 'Qualification records were not checked before job assignment.' },
    ],
    fishbone: {
      man: [
        { id: 'fb6', text: 'Welder W-007 not qualified for thin-wall pressure vessel joint type' },
        { id: 'fb7', text: 'Reduced supervisor oversight due to overtime scheduling' },
      ],
      machine: [],
      material: [],
      method: [{ id: 'fb8', text: 'No mandatory welder qualification check step at job assignment' }],
      measurement: [],
      environment: [],
    },
    actions: [
      { id: 'a16', description: 'Re-qualify welder W-007 per ASME Section IX for thin-wall pressure vessel joints', type: 'CORRECTIVE', owner: 'Vikram Patel', dueDate: '2024-12-01', status: 'COMPLETED', completedDate: '2024-11-28' },
      { id: 'a17', description: 'Implement job-card system requiring welder qualification check before assignment', type: 'PREVENTIVE', owner: 'Rajesh Kumar', dueDate: '2024-12-15', status: 'COMPLETED', completedDate: '2024-12-12' },
      { id: 'a18', description: 'Conduct refresher training for all pressure vessel welders on ASME acceptance criteria', type: 'PREVENTIVE', owner: 'Sunita Rao', dueDate: '2024-12-20', status: 'COMPLETED', completedDate: '2024-12-18' },
    ],
    effectivenessCriteria: 'Zero weld NCs exceeding ASME IX limits in next 10 pressure vessel fabrications',
    monitoringPeriodDays: 120,
    effectivenessResult: 'PASS',
    effectivenessEvidence: 'PV-2025-001 through PV-2025-010: all weld inspections passed with no undercut NCs.',
    history: [
      { id: 'h36', timestamp: '2024-11-06T09:00:00Z', user: 'Deepak Nair', action: 'CAPA Initiated', details: 'Created from NC-2024-0045' },
      { id: 'h37', timestamp: '2024-12-18T16:00:00Z', user: 'Vikram Patel', action: 'Actions Completed', details: 'All actions completed' },
      { id: 'h38', timestamp: '2025-04-10T10:00:00Z', user: 'Priya Sharma', action: 'Closed', details: 'Effectiveness verified — 10 successive pressure vessels with zero weld undercut NCs' },
    ],
  ...
  },
  {
    ...
    title: 'Torque wrench calibration and control improvement',
    description: 'Uncalibrated torque wrench TW-14 used on critical fasteners in pump assembly PA-2024-055 resulting in under-torqued joints. Calibration label not checked before use; no verification step in assembly work instruction.',
    source: 'NC', status: 'CLOSED', severity: 'MAJOR',
    department: 'Production', productProcess: 'Pump Assembly',
    linkedSourceRecord: 'NC-2024-0027',
    owner: 'Deepak Nair', ownerId: 'u6', dueDate: '2024-08-31',
    fiveWhys: [],
    fishbone: {
      man: [],
      machine: [{ id: 'fb9', text: 'Uncalibrated torque wrench TW-14 in active service' }],
      material: [],
      method: [{ id: 'fb10', text: 'Assembly work instruction did not require calibration label verification before tool use' }],
      measurement: [],
      environment: [],
    },
    actions: [
      { id: 'a19', description: 'Withdraw TW-14 from service, recalibrate, and update calibration records', type: 'CORRECTIVE', owner: 'Deepak Nair', dueDate: '2024-07-20', status: 'COMPLETED', completedDate: '2024-07-18' },
      { id: 'a20', description: 'Update assembly work instructions to require calibration label check before tool use', type: 'PREVENTIVE', owner: 'Priya Sharma', dueDate: '2024-08-05', status: 'COMPLETED', completedDate: '2024-08-04' },
      { id: 'a21', description: 'Shadow-board torque wrench storage with colour-coded calibration status indicators', type: 'PREVENTIVE', owner: 'Rajesh Kumar', dueDate: '2024-08-20', status: 'COMPLETED', completedDate: '2024-08-19' },
    ],
    effectivenessCriteria: 'No uncalibrated tool findings in next 3 internal audits',
    monitoringPeriodDays: 90,
    effectivenessResult: 'PASS',
    effectivenessEvidence: 'Internal audits Oct, Nov, Dec 2024: zero findings related to tool calibration.',
    history: [
      { id: 'h39', timestamp: '2024-07-05T08:00:00Z', user: 'Rajesh Kumar', action: 'CAPA Initiated', details: 'Created from NC-2024-0027' },
      { id: 'h40', timestamp: '2024-08-19T15:00:00Z', user: 'Deepak Nair', action: 'Actions Completed', details: 'All actions completed' },
      { id: 'h41', timestamp: '2025-01-05T10:00:00Z', user: 'Priya Sharma', action: 'Closed', details: 'Effectiveness verified after 3 clean audit cycles' },
    ],
    createdAt: '2024-07-05T08:00:00Z', updatedAt: '2025-01-05T10:00:00Z', closedAt: '2025-01-05T10:00:00Z', createdBy: 'Rajesh Kumar',
  },
];
