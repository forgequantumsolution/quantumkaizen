...
const RANGES = ['7D', '1M', '3M', '12M'] as const;
      ...
      <div className="top-inner">
        ...
        <div className="qa-bar">
          ...
          <button
            ...
            onClick={() => navigate('/audit/register')}
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
              <rect x="4" y="5" width="16" height="16" rx="2.5" stroke="currentColor" strokeWidth="1.6" />
          ...
          >
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
              <path d="M9 4h6l1 3h3v13H5V7h3l1-3Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
            </svg>
            <span>CAPA</span>
          </button>
